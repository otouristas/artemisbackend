...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto max-h-[92dvh] flex-col rounded-t-[20px] border-t bg-background pb-[max(env(safe-area-inset-bottom),1rem)]",
        className,
      )}
      {...props}
    >
      <div className="mx-auto mt-2.5 h-1.5 w-9 shrink-0 rounded-full bg-muted-foreground/25" />
